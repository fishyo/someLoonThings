...
| VPS 查询 | Bandwagon 与 RackNerd 状态通知 | [查看脚本配置](https://raw.githubusercontent.com/fishyo/someLoonThings/refs/heads/refactor/cross-platform-scripts/loon/vpsStatus.lpx) | [查看](https://raw.githubusercontent.com/fishyo/someLoonThings/refs/heads/refactor/cross-platform-scripts/loon/vpsStatus.lpx) |
| 九号签到 | 获取凭据并每日自动签到 | [查看脚本配置](https://raw.githubusercontent.com/fishyo/someLoonThings/refs/heads/refactor/cross-platform-scripts/loon/ninebot.lpx) | [查看](https://raw.githubusercontent.com/fishyo/someLoonThings/refs/heads/refactor/cross-platform-scripts/loon/ninebot.lpx) |
...
Loon 官方 Scheme 暂不支持将远程配置一键添加到脚本列表。VPS 与九号签到请打开对应脚本配置，按照其中的 `cron`、`http-request` 和 `hostname` 内容在 Loon 脚本页面手动添加；不要使用 `plugin=` 导入，否则会进入插件列表。
